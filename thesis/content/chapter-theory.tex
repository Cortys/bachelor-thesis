...
\begin{align*}
	...
	V :=\ &concept \mathbin{\dot\cup} relation \mathbin{\dot\cup} context, E := nest \mathbin{\dot\cup} \mathit{coref} \mathbin{\dot\cup} \mathit{arg} \\ % chktex 35
...
\begin{align*}
	dom(G) :\Leftrightarrow\ & \forall\ r, v \in V: \mathit{arg}(r, v) \rightarrow r \leq v \numberthis \\ % chktex 35
	& \land \forall\ v_1, v_2 \in V: \mathit{coref}(v_1, v_2) \rightarrow (v_1 \leq v_2 \lor v_2 \leq v_1)
\end{align*}
Ein Graph $G$ ist ein Konzeptgraph gdw.\ $(V, nest)$ ein Wald ist und $dom(G)$ gilt.
...
In~\cite[Kapitel 10]{Boyd2011} wird beschrieben, wie sich ADMM mit verteilten Datensets und verteilten Programmiermodellen wie z.~B. \textit{Map-Reduce} oder \textit{Pregel} implementieren lässt.
