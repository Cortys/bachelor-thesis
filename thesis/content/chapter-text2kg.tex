...
Wie dies ablaufen kann, ist bislang allerdings noch unklar~\tref{sec:conclusion:todo}.
...
Der erste Schritt der Wissensgraph-Konstruktion ist das Bilden des sog.\ Konjuktionsgraphen.
...
Die geschlossenen Grundatome $\mathbb{C}$ der Eingabe sind die Relationen im Konjuktionsgraphen, die keine offenen Grundatome in einer vorherigen PSL-Inferenz waren.
...
Als offen Grundatommenge $\mathbb{O}$ wird die Menge aller möglicher Relationen verwendet, die nicht in $\mathbb{C}$ liegen.
