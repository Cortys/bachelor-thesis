...
In den Kapiteln~\ref{sec:related} bis~\ref{sec:text2kg} werden diese Komponenten schrittweise genauer betrachtet, was am Ende in einem konkreten Verfahren zur Wissensgraphkonstruktion resultiert.
...
Stattdessen werden stichprobenartig kleine Nachrichtensets eingefügt.
Der resultierende Wissensgraph wird anschließend manuell untersucht.

\paragraph{Kapitel~\ref{sec:conclusion}: \nameref{sec:conclusion}}
Abschließend werden die Ergebnisse zusammengefasst und ein Ausblick auf offen gebliebene Fragestellungen gegeben.
