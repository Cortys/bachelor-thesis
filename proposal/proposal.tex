...
konkret wird abgebildet, dass das Denken als Notwendigkeit verstanden werden kann, d.~h.\ dass für jede Aussage gilt, dass sie entweder gedacht wird oder ihr Gegenteil gedacht wird.
...
Das Einfügen der Nachricht erfolgt im Rahmen der PSL-Phase.
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\ganttbar{Auswertung}{7}{7} \\

		\ganttgroup{Schreiben}{6}{11} \\
		\ganttbar[bar label font = \sffamily, bar label node/.append style = {left = 0.5cm}, bar/.append style = {fill = hellblau}]
			{Überblick, Grundlagen}{6}{7} \\
		\ganttbar[bar label font = \sffamily, bar label node/.append style = {left = 0.5cm}, bar/.append style = {fill = hellblau}]
			{Auswertung}{8}{8} \\
		\ganttbar[bar label font = \sffamily, bar label node/.append style = {left = 0.5cm}, bar/.append style = {fill = hellblau}]
			{Konstruktionsverfahren\hspace{2mm}}{9}{11} \\
