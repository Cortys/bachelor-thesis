...
Da Abhängigkeitsgraphen nur indirekt über die grammatikalische Struktur die semantische Struktur beschreiben, ist neben dem DP und der CR noch eine Transformation in eine zur Ontologie kompatiblen Struktur erforderlich.
...
Gute geeignete NLP Systeme existieren allerdings bereits.
Populär ist z.~B. Stanfords CoreNLP Projekt~\cite{manning:2014}, welches Module zum Dependency Parsing, zum Erkennen von Koreferenzen und zum Kategorisieren von Entitäten (Person, Ort, Zeitpunkt, etc.) beinhaltet.
...
\begin{figure}[H]
	...
	\begin{ganttchart}[
		...
		\ganttbar{NLP Modell}{3}{4} \\
		\ganttbar{PSL Modell}{5}{6} \\

		\ganttbar{Auswertung}{7}{8} \\

		\ganttgroup{Schreiben}{6}{11} \\
		\ganttbar{Konstruktionsverfahren}{6}{8} \\
		\ganttbar{Auswertung}{9}{9} \\
		\ganttbar{Überblick, Grundlagen}{10}{11} \\
